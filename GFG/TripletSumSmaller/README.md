...
<strong>Follow-up:</strong> Can you solve this problem in <code>O(n<sup>2</sup>)</code> time by sorting the array and using the two-pointer technique to count all valid triplets efficiently?
